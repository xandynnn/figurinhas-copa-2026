...
describe('sortTeamsAlphabetically', () => {
  it('should sort teams alphabetically by name', () => {
    const teams: Team[] = [
      { name: "Brasil", code: "BRA", colors: { primary: "#000000", secondary: "#FFFFFF", tertiary: "#009B3A" } },
      { name: "Argentina", code: "ARG", colors: { primary: "#0039A6", secondary: "#FFFFFF", tertiary: "#FFD700" } },
      { name: "Colômbia", code: "COL", colors: { primary: "#FF0000", secondary: "#FFFFFF", tertiary: "#002B7F" } }
    ];
